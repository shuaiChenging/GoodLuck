...
@interface PrintNumberCell ()
@property (nonatomic, strong) UILabel *contentLb;
@property (nonatomic, strong) UIImageView *img;
@end
@implementation PrintNumberCell
...
{
    PrintNumberCell *cell = [tableView dequeueReusableCellWithIdentifier:NSStringFromClass(self)];
    return cell;
}
...
- (void)loadViewWithModel:(PrintNumberModel *)model
{
    ...
    self.img.image = [UIImage imageNamed: model.isSelected ? @"manage_detail_seleted":@"manage_detail_selete_default"];
}
