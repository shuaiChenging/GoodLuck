...
{
    WeakSelf(self)
    GetRequest *request = [[GetRequest alloc] initWithRequestUrl:listapplydelete argument:@{}];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    [cell.detailLb jk_addTapActionWithBlock:^(UIGestureRecognizer *gestureRecoginzer) {
        ...
        workOrderDetailVC.projectId = weakself.source[indexPath.row].projectId;
        [[Tools getTopMostController].navigationController pushViewController:workOrderDetailVC animated:YES];
    }];
