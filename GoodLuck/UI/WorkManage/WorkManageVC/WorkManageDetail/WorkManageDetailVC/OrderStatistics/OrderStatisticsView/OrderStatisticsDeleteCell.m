...
@interface OrderStatisticsDeleteCell ()
...
@end
@implementation OrderStatisticsDeleteCell
...
{
    OrderStatisticsDeleteCell *cell = [tableView dequeueReusableCellWithIdentifier:NSStringFromClass(self)];
    return cell;
}
