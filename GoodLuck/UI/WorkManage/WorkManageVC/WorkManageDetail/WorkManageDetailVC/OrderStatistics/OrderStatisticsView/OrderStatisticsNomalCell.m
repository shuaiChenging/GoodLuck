...
@interface OrderStatisticsNomalCell ()
...
@end
@implementation OrderStatisticsNomalCell
...
{
    OrderStatisticsNomalCell *cell = [tableView dequeueReusableCellWithIdentifier:NSStringFromClass(self)];
    return cell;
}
